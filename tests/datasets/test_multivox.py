...
def test_track():
    ...
    expected_attributes = {
        ...
        "audio_ortf_l_path": os.path.join(
            data_home,
            "C1_07052025_S1_MAMAINES_P6_S6/C1_07052025_S1_MAMAINES_P6_S6_ortf_l.wav",
        ),
        "audio_ortf_r_path": os.path.join(
            data_home,
            "C1_07052025_S1_MAMAINES_P6_S6/C1_07052025_S1_MAMAINES_P6_S6_ortf_r.wav",
        ),
        "video_360_path": os.path.join(
            data_home,
            "C1_07052025_S1_MAMAINES_P6_S6/C1_07052025_S1_MAMAINES_P6_S6_360.mp4",
        ),
        "audio_360_path": None,
        "near_field_recordings": {
            "S1": os.path.join(
                data_home,
                "C1_07052025_S1_MAMAINES_P6_S6/C1_07052025_S1_MAMAINES_P6_S6_S1.wav",
            ),
            "S2": os.path.join(
                data_home,
                "C1_07052025_S1_MAMAINES_P6_S6/C1_07052025_S1_MAMAINES_P6_S6_S2.wav",
            ),
            "S3": os.path.join(
                data_home,
                "C1_07052025_S1_MAMAINES_P6_S6/C1_07052025_S1_MAMAINES_P6_S6_S3.wav",
            ),
            "S4": os.path.join(
                data_home,
                "C1_07052025_S1_MAMAINES_P6_S6/C1_07052025_S1_MAMAINES_P6_S6_S4.wav",
            ),
            "S5": os.path.join(
                data_home,
                "C1_07052025_S1_MAMAINES_P6_S6/C1_07052025_S1_MAMAINES_P6_S6_S5.wav",
            ),
            "S6": os.path.join(
                data_home,
                "C1_07052025_S1_MAMAINES_P6_S6/C1_07052025_S1_MAMAINES_P6_S6_S6.wav",
            ),
        },
        "song": "MAMAINES",
        "duration": 2.0,
    ...
    expected_property_types = {
        ...
        "audio_360": (type(None), tuple),  # Can be None if not available
...
def test_track_with_empty_position():
    ...
    # Verify facing direction counts: None is not included in the counts dict keys
    # because it's filtered out in Track.facing_directions_counts if we use
    # facing_directions property which now has Nones.
    # Wait, let's check Track.facing_direction_counts implementation.
    # It uses self.facing_directions which has Nones.
    # dict(Counter([..., None, ...])) will have None as a key.
